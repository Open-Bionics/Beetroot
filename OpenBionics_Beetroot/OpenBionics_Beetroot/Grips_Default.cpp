...
uint16_t default_GripPos[NUM_GRIPS][NUM_GRIP_STEPS][NUM_FINGERS + 1] = {		 
	...
	{	// PINCH
		...
		{ BLANK,	BLANK,			BLANK,			BLANK,			BLANK },		//MIDPOINTC
		{ BLANK,	BLANK,			BLANK,			BLANK,			BLANK },		//MIDPOINTD
		{ 100,		800,			FULLY_CLOSED,	FULLY_OPEN,		FULLY_OPEN },	//CLOSED
	},
	{	// TRIPOD
		//COUNT		F0				F1				F2				F3 & F4
		...
		{ BLANK,	BLANK,			BLANK,			BLANK,			BLANK },		//MIDPOINTC
		{ BLANK,	BLANK,			BLANK,			BLANK,			BLANK },		//MIDPOINTD
		{ 100,		900,			FULLY_CLOSED,	FULLY_CLOSED,	FULLY_OPEN },	//CLOSED
	},
	{	// FINGER ROLL
		//COUNT		F0				F1				F2				F3 & F4
		{ 0,		FULLY_OPEN,		FULLY_OPEN,		FULLY_OPEN,		FULLY_OPEN },	//OPEN
	...
	{	// SUPER GRIP
		//COUNT		F0				F1				F2				F3 & F4
		{ 0,		FULLY_OPEN,		FULLY_OPEN,		FULLY_OPEN,		FULLY_OPEN },	//OPEN
		{ 20,		MID_POS,		FULLY_OPEN,		FULLY_OPEN,		MID_POS },		//MIDPOINTA
		{ 40,		800,			FULLY_OPEN,		FULLY_OPEN,		FULLY_CLOSED },	//MIDPOINTB
		{ 60,		FULLY_CLOSED,	FULLY_OPEN,		FULLY_OPEN,		FULLY_CLOSED },	//MIDPOINTC
		{ 80,		FULLY_CLOSED,	FULLY_CLOSED,	MID_POS,		FULLY_CLOSED },	//MIDPOINTD
		{ 100,		FULLY_CLOSED,	FULLY_CLOSED,	FULLY_CLOSED,	FULLY_CLOSED },	//CLOSED
	},
};