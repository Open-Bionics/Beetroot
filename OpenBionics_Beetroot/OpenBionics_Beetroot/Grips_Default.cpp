...
uint16_t default_GripPos[NUM_GRIPS][NUM_GRIP_STEPS][NUM_FINGERS + 1] = {		 
	...
	{	// PINCH
		//COUNT		F0				F1				F2				F3 & F4
		{ 0,		FULLY_OPEN,		FULLY_OPEN,		FULLY_OPEN,		FULLY_OPEN },	//OPEN
		{ 10,		480,			BLANK,			BLANK,			BLANK },		//MIDPOINTA
		{ 79,		480,			BLANK,			BLANK,			BLANK },		//MIDPOINTB
		{ BLANK,	BLANK,			BLANK,			BLANK,			BLANK },		//MIDPOINTC
		{ BLANK,	BLANK,			BLANK,			BLANK,			BLANK },		//MIDPOINTD
		{ 100,		480,			FULLY_CLOSED,	FULLY_OPEN,		FULLY_OPEN },	//CLOSED
	},

	{	// TRIPOD
		//COUNT		F0				F1				F2				F3 & F4
		{ 0,		FULLY_OPEN,		FULLY_OPEN,		FULLY_OPEN,		FULLY_OPEN },	//OPEN
		{ 2,		520,			BLANK,			BLANK,			BLANK },		//MIDPOINTA
		{ 85,		520,			BLANK,			BLANK,			BLANK },		//MIDPOINTB
		{ BLANK,	BLANK,			BLANK,			BLANK,			BLANK },		//MIDPOINTC
		{ BLANK,	BLANK,			BLANK,			BLANK,			BLANK },		//MIDPOINTD
		{ 100,		520,			FULLY_CLOSED,	FULLY_CLOSED,	FULLY_OPEN },	//CLOSED
	},
	{	// FINGER ROLL
		//COUNT		F0				F1				F2				F3 & F4
		{ 0,		FULLY_OPEN,		FULLY_OPEN,		FULLY_OPEN,		FULLY_OPEN },	//OPEN
